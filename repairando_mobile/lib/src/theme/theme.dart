...
class AppTheme {
  ...
  static const int ANIMATION_DURATION = 600;
  static const double LOGO_SIZE = 60.0;
  static const double SPLASH_LOGO_WDITH = 280.0;
  static const Color FILL_COLOR = Color.fromRGBO(243, 246, 249, 0);
  static const Color PIN_BORDER_COLOR = Color.fromRGBO(23, 171, 144, 0.4);
  static const Color BLUE_WORKSHOP_COLOR = Color.fromARGB(255, 232, 245, 255);

  // Main ThemeData - This should be used in your app.dart
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: GoogleFonts.manrope(color: TEXT_COLOR, fontSize: 15),
  ...
  static final PinTheme defaultPinTheme = PinTheme(
    width: 56,
    height: 56,
    textStyle: GoogleFonts.manrope(fontSize: 22, color: TEXT_COLOR),
  ...
  static final List<Color> SERVICE_COLORS = [
