...
void main() {
  ...
  testWidgets('shows localized price', (tester) async {
    await _pumpScreen(
      tester,
      ConfirmBookingSummaryScreen(
        appointmentModel: _buildAppointment(price: '1999.5'),
      ),
    );

    expect(find.text('1.999,50 €'), findsOneWidget);
  });
}
